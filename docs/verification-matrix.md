...
|---|---|---|---|
| ELEC-01 | USB 5 V SELV only; certified enclosed ≥2 A external supply; no mains | Static schematic/BOM inspection; assembled visual inspection | SC0218 supply and protected USB-C topology selected; schematic/received-unit inspection open |
| ELEC-02 | Device peak ≤1.5 A at 5 V allocation | Static source-backed current sum + PCB review; bench idle/peak/inrush measurement | 1.05 A planning allocation plus 1.53 kΩ ILM choice recorded; worst-case/current/thermal measurement open |
...
| ELEC-04 | Valid RTC time after 24 h main-power removal; drift reported | Datasheet/static review then bench retention/drift test | DS3231MZ+/CR2032 no-charge topology selected; bench retention/drift open |
...
| ELEC-06 | Dedicated controls; single action; ≤100 ms valid-press response | Static GPIO review; host debounce fixture; bench latency capture | Exact switches/encoder and conflict-free GPIOs selected; behavior untested |
...
| ELEC-09 | Source-backed input/ESD/decoupling; no undocumented back-power | Datasheet/schematic static review, ERC/cross analysis, staged bring-up | Connector/TVS/eFuse topology and DevKit Schottky boundary selected; schematic and bring-up open |
| ELEC-10 | Named test access for rails/reset/RTC/backlight/audio/controls | Schematic/PCB static inspection and continuity bench check | Required net/pad names recorded in pin allocation; implementation open |
...
| COST-04 | Validate MPN/pin/package/thermal/lifecycle/source before purchase | Static BOM/datasheet audit | Functional MPNs/source manifest selected; exact passives, KiCad properties, received revisions, and purchase-time lifecycle check open |
