...
drafts, schedule mirror, versioned backup) is software-only evidence: the code
is not wired to any screen, filesystem, or transport, its tests run on the
