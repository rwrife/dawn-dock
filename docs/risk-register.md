...
| R-004 | Invalid RTC or failed backup loses time during outage | M/H | Hardware / Firmware | Source-backed RTC selection, safe backup circuit, validity flag, 24 h retention requirement, visible fault | Datasheet/schematic review; bench retention/drift measurement | L/H | Open—RTC undecided |
...
| R-006 | Display cannot become dark enough for bedside use | H/M | Hardware / UX | ≤1 cd/m² lowest lit target, true blackout, hardware backlight option, module fallback | Source review then dark-room luminance bench measurement | L/M | Open—candidate unmeasured |
| R-007 | Alarm is inaudible or unexpectedly loud | M/H | Hardware / Firmware | Bounded adjustable output, 60–75 dBA normal target, ≤80 dBA maximum target, volume UI | Circuit/static review; calibrated A-weighted 1 m enclosure measurement | L/H | Open—audio undecided |
...
| R-014 | Provisional module pinout/back-power/RTC/audio assumptions damage hardware or invalidate design | H/H | Hardware | Manufacturer schematic/datasheet/mechanical review, exact revision lock, pin/resource table, no undocumented back-power | Source citations, schematic pin audit, ERC/cross analysis, staged current-limited bring-up | L/H | Open—blocks schematic |
...
| R-016 | RTC backup cell is charged despite non-rechargeable chemistry or installed reversed | M/H | Hardware | Source-backed topology, keyed/marked holder, no charging path to primary cell, polarity silk | Datasheet/schematic review, continuity inspection, staged bring-up | L/H | Open—cell path undecided |
...
| R-019 | Prototype cost or part availability breaks reproducibility | H/M | BOM / Hardware | <USD 75 ceiling, dated price/stock, exact MPN/source fields, alternatives only after validation | BOM validation and dated sourcing snapshot; no future-availability claim | M/M | Open |
...
1. **R-014** blocks schematic capture until exact module/component documents and pin/resource allocation are complete.
